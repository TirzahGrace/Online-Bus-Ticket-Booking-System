...
<body>
    ...
    <?php require_once '../assets/partials/_user-header.php';//checked once for changes not exactly anything specific
    require_once '../assets/partials/_getJSON.php';//json is getting all the values from the db as an array
            ...
            <section id="dashboard">
                ...
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="./user_booking.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="./user_bus.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        ...
                        <a href="./user_route.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <!-- <h3>User</h3> -->
