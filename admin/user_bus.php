                ...
                if(isset($_GET['q']))
                {
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            $count++;
                            $sql2= "SELECT * FROM `routes` WHERE `bus_no` = '$bus'";
                            ...
                            $num2 = mysqli_num_rows($result2);
                                if($num2)
                                {
                                    ...
                                    {
                                        $from_dest=$row2['route_from'];
                                        $to_dest=$row2['route_to'];
                                        $dept_date=$row2['route_dep_date'];
                                        $dept_time=$row2['route_dep_time'];
                                        echo '<tr>
                                ...
                                {
                                   echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                             No Routes found for the following bus ' ;
