...
<body>
    ...
    <?php require '../assets/partials/_user-header.php';//checked once for changes not exactly anything specific
        require '../assets/partials/_getJSON.php';//json is getting all the values from the db as an array
